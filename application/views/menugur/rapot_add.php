                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                                <?php echo form_open_multipart("C_rguru/saverapot/" . $id); ?>
                                            ...
                                            <form action="#">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <input name="nilai" type="number" class="form-control" placeholder="Nilai" value="">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="pts" type="number" class="form-control" placeholder="PTS" value="">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="pas" type="number" class="form-control" placeholder="PAS" value="">
                                                        </div>
                                                        <div class="form-group">
