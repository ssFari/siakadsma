                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        ...
                        <div class="add-product">
                            <a href="<?php echo base_url('C_rguru/addrapotpts/'. $id ); ?>">Add Data</a>
                        </div>
                        </div>
                        <div class="sparkline13-graph">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value->nilaipts ?></td>
                                    <td class="datatable-ct">
                                        <a href="<?php echo base_url('C_rguru/editrapotpts/'.$value->nisn.'/'.$value->kode_mp) ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                    </td>                                 
                                </tr>
                                <?php
                                $no++; 
