                    ...
                    <div class="sparkline13-graph">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $value->nmg ?></td>
                                <td><?php echo $value->nip ?></td>
                                <td class="datatable-ct">
                                    <a href="<?php echo base_url('C_rguru/detailjadwal/'.$value->kode_kelas) ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                </td>
                            </tr>
                            <?php
                            $no++; 
