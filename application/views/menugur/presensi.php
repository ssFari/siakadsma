                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="datatable-ct">
                                    <a href="<?php echo base_url('C_rguru/detailpresensi/'.$value->nisn) ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                </td>
                            </tr>
                            <?php
                            $no++; 
